...
// // ------------------ MAIN JOB ------------------
// module.exports = async function processReferences() {
//   console.log("🔗 Processing external references...");
...
//     if (references.length === 0) {
//       console.log("⚠️ No valid references, skipping");
//       continue;
//     }
...
//   console.log("🎉 Reference scraping completed");
// };
